...
INSERT INTO clientes
  (nombre, usuario, email, contrasena, fechaNacimiento, peso, altura, genero)
VALUES
  ('Kepa', 'kepab', 'kepa@example.com', 'password1', '1990-01-01', 70.5, 180.0, 'Hombre'),
  ('Ander', 'andere', 'ander@example.com', 'password2', '1995-05-05', 65.2, 175.0, 'Hombre');
