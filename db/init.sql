...
('Energia', 'Cantidad de energia proporcionada por el alimento', 'kcal'),
('Lipidos totales (grasas)', 'Grasas totales presentes en el alimento', 'g'),
('Acidos grasos, saturados totales', 'Grasas saturadas presentes en el alimento', 'g'),
('Acidos grasos, trans totales', 'Grasas trans presentes en el alimento', 'g'),
('Acidos grasos monoinsaturados totales', 'Grasas monoinsaturadas presentes en el alimento', 'g'),
('Acidos grasos poliinsaturados totales', 'Grasas poliinsaturadas presentes en el alimento', 'g'),
('Carbohidratos, por diferencia', 'Carbohidratos presentes en el alimento', 'g'),
('Fibra dietetica total', 'Fibra dietetica presente en el alimento', 'g'),
('Azucares, total incluyendo NLEA', 'Azucares totales presentes en el alimento', 'g'),
('Proteina', 'Proteina presente en el alimento', 'g'),
...
('Fosforo, P', 'Fosforo presente en el alimento', 'mg'),
('Vitamina A, RAE', 'Vitamina A presente en el alimento', 'mcg'),
('Vitamina C, acido ascorbico total', 'Vitamina C presente en el alimento', 'mg'),
...
('Folato, DFE', 'Folato presente en el alimento', 'mcg'),
('Folato, comida', 'Folato de origen alimentario presente en el alimento', 'mcg'),
('Acido folico', 'Acido folico presente en el alimento', 'mcg'),
('Vitamina B12', 'Vitamina B12 presente en el alimento', 'mcg'),
('Vitamina D (D2 + D3)', 'Vitamina D presente en el alimento', 'mcg'),
('Vitamina E (alfa-tocoferol)', 'Vitamina E presente en el alimento', 'mg'),
('Vitamina K (filoquinona)', 'Vitamina K presente en el alimento', 'mcg'),
